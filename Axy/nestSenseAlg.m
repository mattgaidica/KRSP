...
sense.tempGradOdba = sense.tempGrad .* sense.smOdba; % this does NOT get normalized, !!unweighted?
...
sense.nest = sense.tempZ + sense.tempGradOdba + sense.invOdba + sense.tempRange + sense.kmeansNest;
...
if senseParams.fixTransitions
    binNestSense = fixTransitions(binNestSense,sense);
end